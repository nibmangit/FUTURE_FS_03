...
return ( 
    <div className="w-full h-[60vh] flex flex-col items-center justify-center animate-in fade-in duration-500">
      <div className="relative w-16 h-16">
        <div className="absolute inset-0 rounded-full border-2 border-[#22FF88]/10 animate-ping"></div>
        <div className="absolute inset-0 rounded-full border-t-2 border-[#00E5FF] animate-spin shadow-[0_0_15px_#00E5FF]"></div>
      ...
      <div className="mt-6 flex flex-col items-center">
        <p className="text-[#22FF88] font-mono text-[10px] tracking-[0.3em] uppercase opacity-70">
          {message}
        </p>
      </div>
    </div>
