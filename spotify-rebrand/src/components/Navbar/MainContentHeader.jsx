  ...
  return (
    <div className={`sticky top-0 z-30 w-full p-4 ${getGlassClass()} rounded-none`}>
      ...
      <div className="hidden lg:flex items-center justify-between space-x-6">
        ...
        {/* REPLACED INPUT WITH TITLE: This maintains the exact same layout spacing */}
        <div className="flex items-center w-full max-w-sm">
          <h1 className="text-2xl font-bold text-white tracking-tight animate-in slide-in-from-left duration-500">
            {titleMap[currentPage] || 'CyberBeat'}
          </h1>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2 cursor-pointer p-1 rounded-full hover:bg-white/10 transition-colors duration-200">
            <div className="w-8 h-8 rounded-full bg-[#00E5FF] flex items-center justify-center text-sm font-bold text-black shadow-[0_0_15px_rgba(0,229,255,0.4)]">
              <User size={16} />
            </div>
