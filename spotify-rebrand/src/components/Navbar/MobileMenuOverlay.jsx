  ...
  return (
    <div className={`fixed inset-0 z-100 p-6 lg:hidden ${getGlassClass()} rounded-none flex flex-col bg-[#050505]/95`}>
      <div className="flex justify-between items-center mb-10">
        ...
        <button onClick={onClose} className="text-white/80 p-2 border border-white/10 cursor-pointer rounded-full hover:bg-white/10 active:scale-90 transition-transform">
        ...
        {navItems.map(item => {
          ...
          return (
            <button
              ...
              className={`flex items-center w-full p-4 rounded-xl font-medium transition-all duration-200 text-lg cursor-pointer
                          ${isActive 
